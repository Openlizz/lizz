...
func init() {
	...
	refreshCmd.PersistentFlags().BoolVarP(&refreshArgs.upgrade, "upgrade", "u", false, "if true, the application will be upgraded with the latest changes from the `origin-branch` Git branch")
